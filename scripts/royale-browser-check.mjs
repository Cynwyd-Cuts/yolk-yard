...
try{
 ...
 const mobile=await make('Pocket Egg',true);await mobile.locator('[data-action="play"]').click();await mobile.locator('[data-action="play-royale"]').click();await mobile.locator('[data-action="play-local"]').click();await mobile.locator('#royale-hud').waitFor();await mobile.screenshot({path:'test-results/royale-mobile.png'});
