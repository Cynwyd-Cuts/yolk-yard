...
5. Keep GitHub Pages enabled with GitHub Actions as its publishing source. The workflow publishes `main`. Open your Pages `/admin.html`, enter your owner key, then request access from the Pages game and approve it. Your game screen enters automatically. The Worker `/admin` remains available too.
